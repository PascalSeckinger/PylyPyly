...
;hljs.registerLanguage("javascript",e)})();/*! `sql` grammar compiled for Highlight.js 11.3.1 */
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `xml` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("markdown",e)})();/*! `php` grammar compiled for Highlight.js 11.3.1 */
...
;hljs.registerLanguage("php-template",n)})();/*! `python` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("python",e)})();/*! `bash` grammar compiled for Highlight.js 11.3.1 */
...
subLanguage:"bash"}}]})})();hljs.registerLanguage("shell",s)})();/*! `scss` grammar compiled for Highlight.js 11.3.1 */
(()=>{var e=(()=>{"use strict"
